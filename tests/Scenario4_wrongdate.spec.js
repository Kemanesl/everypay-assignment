...
test('failed payment with wrong date', async ({ page }) => {
    ...
    await frame.type('#expiryDate', '0122'); // Wrong date format (MMYY)
    ...
    expect(errorMessage).toBe('The expiration date is invalid');
});
