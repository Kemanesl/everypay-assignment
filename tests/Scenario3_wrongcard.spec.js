...
test('failed payment with wrong card number', async ({ page }) => {
    ...
    await frame.type('#cardNumber', '4111111111111110'); // Wrong card number
    ...
    expect(errorMessage).toBe('Your card number is invalid');
});
